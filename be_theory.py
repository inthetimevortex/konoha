...
def t_tms_from_Xc(M, savefig=None, plot_fig=None, ttms_true=None, Xc=None):
    ...
    mass = np.array([14.6, 12.5, 10.8, 9.6, 8.6, 7.7, 6.4, 5.5, 4.8, 4.2, 3.8, 3.4])
    ...
    Hfracf = 0.0  # end of main sequence

    # ****
    folder_data = "/home/amanda/Dropbox/Amanda/GRID/BEMCEE/tables/models/models_bes/"
    ...
    for i in range(nm):
        ...
        age, lum, Teff, Hfrac = np.loadtxt(
            file_data, usecols=typ, unpack=True, skiprows=2
        )
        arr_age.append(age)
